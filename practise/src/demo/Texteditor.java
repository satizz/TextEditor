...
public class Texteditor extends JFrame implements ActionListener {
    ...
    private JMenuItem aboutushelp,helphelp;
    ...
    private void helpMenu() {
        ...
        /*add help menu items*/
        aboutushelp = new JMenuItem("About Us");
        aboutushelp.addActionListener(this);
        aboutushelp.setPreferredSize(new Dimension(100, 20));
        aboutushelp.setEnabled(true);
        
        helphelp = new JMenuItem("Help");
        helphelp.addActionListener(this);
        helphelp.setPreferredSize(new Dimension(100, 20));
        helphelp.setEnabled(true);
        
        helpMenu.add(aboutushelp);
    ...
    public void actionPerformed(ActionEvent event) {
        if(event.getSource() == newFile) {
            ...
            textArea.cut();
        }else if(event.getSource() == helphelp){
            editorWindow = new JFrame("Help");
        editorWindow.setVisible(true);
        editorWindow.setExtendedState(Frame.ICONIFIED);
        editorWindow.setDefaultCloseOperation(EXIT_ON_CLOSE);
        editorWindow.setSize(500,400);
        /* Create Menu Bar
        editorWindow.setJMenuBar(createMenuBar());
        editorWindow.add(scroll, BorderLayout.CENTER);
        editorWindow.pack();
